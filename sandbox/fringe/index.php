...
<!--Stylesheets-->
<link rel="stylesheet" type="text/css" href="/simpletip/sandbox/fringe/sandbox.css"  />
<link rel="stylesheet" type="text/css" href="/simpletip/sandbox/fringe/prettify.css" />
<!--Meta-->
...
<div id="master">
   <div id="side">
      <div id="navigation">
         <img class="logo" src="/simpletip/sandbox/fringe/images/logo.png" alt="Simpletip" />
         
         <div class="links">
            <a rel="overview" href="#">Overview</a>
            <a rel="demonstrations" href="#">Demonstrations</a>
            <a rel="configuration" href="#">Configuration</a>
            <a rel="tutorials" href="#">Tutorials</a>
            <a rel="styling" href="#">Styling</a>
            <a rel="documentation" href="#">Documentation</a>
            <a rel="troubleshooting" href="#">Troubleshooting</a>
            <a rel="license" href="#">License</a>
            <a rel="download" href="#">Download</a>
            <a rel="contact" href="#">Contact</a>
         </div>
         
         <a href="/"><img class="portfolio" src="/simpletip/sandbox/fringe/images/craigsworks.png" alt="Craig Thompson" /></a>
         
         <h5>Donations</h5>
         If you like my work please contribute a donation. Every penny makes it worth while!
         <form class="donation" action="https://www.paypal.com/cgi-bin/webscr" method="post">
            <input type="hidden" name="cmd" value="_s-xclick" />
            <input type="hidden" name="hosted_button_id" value="3178646" />
   ...
   <div id="content">
      <div class="head">
         ...
         <div id="testimonial">
            <div>Simpletip makes creating tooltips quick and painless, with minimal code!</div>
         </div>
      </div>
      
      <div id="overview" class="section">
         <img class="preview right" src="/simpletip/sandbox/fringe/images/screenshot1.png" alt="" />
      ...
      <div id="demonstrations" class="section">
         ...
         <ul class="rooms">
            <li class="room simple">
               <div class="pad1 pad-simple"><img src="/simpletip/sandbox/fringe/images/demo/simple.jpg" alt="" height="22" width="95" /></div>
               Simple
            </li>
            
            <li class="room style">
               <div class="pad2 pad-style1"><img src="/simpletip/sandbox/fringe/images/demo/style1.jpg" alt="" height="22" width="45" /></div>
               <div class="pad2 pad-style2"><img src="/simpletip/sandbox/fringe/images/demo/style2.jpg" alt="" height="22" width="45" /></div>
               <div class="clear">&nbsp;</div>
               Styles
            </li>
            
            <li class="room border">
               <div class="pad3 pad-border1"><img src="/simpletip/sandbox/fringe/images/demo/border1.jpg" alt="" height="22" width="28" /></div>
               <div class="pad3 pad-border2"><img src="/simpletip/sandbox/fringe/images/demo/border2.jpg" alt="" height="22" width="28" /></div>
               <div class="pad3 pad-border3"><img src="/simpletip/sandbox/fringe/images/demo/border3.jpg" alt="" height="22" width="28" /></div>
               <div class="clear">&nbsp;</div>
               Round
            </li>
            
            <li class="room stems">
               <div class="pad3 pad-stem-lm"><img src="/simpletip/sandbox/fringe/images/demo/stem1.jpg" alt="" height="22" width="28" /></div>
               <div class="pad3 pad-stem-tm"><img src="/simpletip/sandbox/fringe/images/demo/stem2.jpg" alt="" height="22" width="28" /></div>
               <div class="pad3 pad-stem-br"><img src="/simpletip/sandbox/fringe/images/demo/stem3.jpg" alt="" height="22" width="28" /></div>
               <div class="clear">&nbsp;</div>
               Stems
            </li>
            
            <li class="room hooks">
               <div class="pad3 pad-hook"><img src="/simpletip/sandbox/fringe/images/demo/hook.jpg" alt="" height="22" width="28" /></div>
               <div class="pad3 pad-hook-stem"><img src="/simpletip/sandbox/fringe/images/demo/hookstem.jpg" alt="" height="22" width="28" /></div>
               <div class="pad3 pad-hook-mouse"><img src="/simpletip/sandbox/fringe/images/demo/mouse.jpg" alt="" height="22" width="28" /></div>
               <div class="clear">&nbsp;</div>
               Hooking
            </li>
            
            <li class="room target">
               <div class="pad1 pad-target"><img src="/simpletip/sandbox/fringe/images/demo/target.jpg" alt="" height="22" width="95" /></div>
               <div class="clear">&nbsp;</div>
               Target
            </li>
            
            <li class="room title">
               <div class="pad1 pad-title"><img src="/simpletip/sandbox/fringe/images/demo/title.jpg" alt="" height="22" width="95" /></div>
               <div class="clear">&nbsp;</div>
               Titles
            </li>
            
            <li class="room buttons">
               <div class="pad2 pad-buttons-text"><img src="/simpletip/sandbox/fringe/images/demo/buttontext.jpg" alt="" height="22" width="45" /></div>
               <div class="pad2 pad-buttons-image"><img src="/simpletip/sandbox/fringe/images/demo/buttonimage.jpg" alt="" height="22" width="45" /></div>
               <div class="clear">&nbsp;</div>
               Buttons
            </li>
            
            <li class="room events">
               <div class="pad2 pad-events1"><img src="/simpletip/sandbox/images/fringe/demo/eventpreset.jpg" alt="" height="22" width="45" /></div>
               <div class="pad2 pad-events2"><img src="/simpletip/sandbox/images/fringe/demo/eventcustom.jpg" alt="" height="22" width="45" /></div>
               <div class="clear">&nbsp;</div>
               Events
            </li>
            
            <li class="room click">
               <div class="pad1 pad-click"><img src="/simpletip/sandbox/fringe/images/demo/click.jpg" alt="" height="22" width="95" /></div>
               <div class="clear">&nbsp;</div>
               Click
            </li>
            
            <li class="room delay">
               <div class="pad1 pad-delay"><img src="/simpletip/sandbox/fringe/images/demo/delay.jpg" alt="" height="22" width="95" /></div>
               <div class="clear">&nbsp;</div>
               Delay
            </li>
            
            <li class="room hideafter">
               <div class="pad1 pad-hideafter"><img src="/simpletip/sandbox/fringe/images/demo/hideafter.jpg" alt="" height="22" width="95" /></div>
               <div class="clear">&nbsp;</div>
               Hide after
            </li>
            
            <li class="room offset">
               <div class="pad1 pad-offset"><img src="/simpletip/sandbox/fringe/images/demo/offset.jpg" alt="" height="22" width="95" /></div>
               <div class="clear">&nbsp;</div>
               Offset
            </li>
            
            <li class="room viewport">
               <div class="pad1 pad-viewport"><img src="/simpletip/sandbox/fringe/images/demo/viewport.jpg" alt="" height="22" width="95" /></div>
               <div class="clear">&nbsp;</div>
               Viewport
            </li>
            
            <li class="room ajax">
               <div class="pad1 pad-ajax"><img src="/simpletip/sandbox/fringe/images/demo/ajax.jpg" alt="" height="22" width="95" /></div>
               <div class="clear">&nbsp;</div>
               Ajax
            </li>
         </ul>
...
<div id="configuration" class="section">
   ...
   offset: [20, 0]
         ...
         <div id="hooks" class="subsection">
            <img class="right hooks" src="/simpletip/sandbox/fringe/images/hooks.jpg" alt="" />
            <h3>Hooks</h3>
...
offset: [0, 10]</code>
         ...
         <div id="stems" class="subsection">
            <img class="right stems" src="/simpletip/sandbox/fringe/images/stems.jpg" alt="" />
            <h3>Stems</h3>
...
hideEffect: function(){ $(this).hide("slide"); }</code>
         ...
         <div id="override" class="subsection">
            <h3>Overriding default configuration</h3>
            <p>As of <b>beta5</b> the default configuration options are globally overridable. This means you can change the default options which apply to all tooltips created by the library. This is accomplished as so:</p>
            <code class="prettyprint lang-js">$.fn.simpletip.defaults.option = 'value'; //Replace option and value with desired option/value pairs</code>
            <p>For example, if I wish to change the default stem colour of all tooltips created I can do this:</p>
            <code class="prettyprint lang-js">$.fn.simpletip.defaults.stem.color = 'red';</code>
            <p>To change the default position of all tooltips I can do this:</p>
            <code class="prettyprint lang-js">$.fn.simpletip.defaults.hook.target = 'bottomMiddle';</code>
            <p>For a full list of configuration options checkout the <a rel="documentation" href="#">documentation</a> section.</p>
         </div>
         
         <div id="massadd" class="subsection last">
            <h3>Mass addition of tooltips</h3>
            <p>Using the power of jQuery's selectors, adding tooltips to several elements at once is a snap. Heres how to add tooltips to all links on a page, using their rel attributes as the tooltip contents:</p>
            <code class="prettyprint lang-js">$('a[rel]').each(function(){
   $(this).simpletip( $(this).attr('rel') );
});</code>
         </div>
      </div>
...
title: { content: 'Tooltip title', button: '.mybutton' } //Again, note the full selector string</code>
  ...
  method: 'get' // Explicit method type. If 'get', data object is ignored.
            ...
            <tr>
               ...
               <td class="desc">Class name to apply to active (currently shown) tooltip elements. Default: active</td>
            </tr>
            <tr>
...
border: false</code>
            ...
            <tr>
               ...
               <td class="desc">Class name to apply to button elements. Default: button</td>
            </tr>
            <tr>
               <td class="name">contentClass</td>
               <td class="desc">Class name to apply to generated tooltip content elements. Default: content</td>
            </tr>
            <tr>
               <td class="name">delay</td>
               <td class="desc">Delay in milliseconds before the tooltip appears. Default: 140</td>
            </tr>
            <tr>
               <td class="name">hidden</td>
               <td class="desc">Set to false to show the tooltip will immediately when created. Default: true</td>
            </tr>
            <tr>
            ...
            <tr>
               ...
               <td class="desc">Type of hide effect to use (fade, slide or none). Default: fade</td>
            </tr>
            <tr>
...
hideOn: false // useful in combination with hideAfter</code>
            ...
            <tr>
               ...
               <td class="desc">When true, other tooltips will be hidden before showing the tooltip. Default: false</td>
            </tr>
            <tr>
               <td class="name">hideTime</td>
               <td class="desc">Time in milliseconds for <span class="prop">hideEffect</span> effect. Default: 150</td>
            </tr>
            <tr>
...
hook: { tooltip: 'bottomRight', mouse: true }</code>
            ...
            <tr>
               ...
               <td class="desc">Class name to apply to generated tooltip elements. Default: tooltip</td>
            </tr>
            <tr>
               <td class="name">showEffect</td>
               <td class="desc">Type of show effect to use (fade, slide or none). Default: fade</td>
            </tr>
            <tr>
               <td class="name">showOn</td>
               <td class="desc">The event that shows the tooltip. Default: 'mousemove'. <code class="prettyprint lang-js">showOn: 'click'</code> </td>
            </tr>
            <tr>
               <td class="name">showTime</td>
               <td class="desc">Time in milliseconds for <span class="prop">showEffect</span> effect. Default: 150</td>
            </tr>
            <tr>
...
stem: false</code>
            ...
            <tr>
               ...
               <td class="desc">Class name to apply to generated stem elements. Default: stem</td>
            </tr>
            <tr>
...
title: false</code>
            ...
            <tr>
               ...
               <td class="desc">Class name to apply to title elements. Default: title</td>
            </tr>
            <tr>
            ...
            <tr>
               ...
               <td class="desc">Sets the width of the tooltip. Default: false</td>
            </tr>
         </table>
...
api.update('New tooltip content!'); // Perform a simple API call to update tooltip contents</code>
      ...
      <div id="contact" class="section last">
         ...
         <p>For anything non-support related you can contact me at <a href="mailto:craig@craigsworks.com">craig[at]craigsworks.com</a></p>
      </div>
      
      <div id="footer">
         <a href="http://code.google.com/p/google-code-prettify/">google code prettify</a> |
         special thanks to <a href="http://www.nickstakenburg.com/">Nick Stakenburg</a> | 
         content copyright &copy; 2009 <a href="/">Craig Thompson</a>
      </div>
...
<!--Scripts-->
<script type="text/javascript" src="/simpletip/sandbox/fringe/jquery-1.3.1.min.js"></script>
<script type="text/javascript" src="/simpletip/sandbox/fringe/jquery-ui-personalized-1.6rc6.min.js"></script>
<?php if($version == 'sandbox'){ ?><script type="text/javascript" src="/simpletip/sandbox/fringe/jquery.simpletip-sandbox.js"></script>
<?php } ?>

<script type="text/javascript" src="/simpletip/sandbox/fringe/js/prettify.js"></script>
<script type="text/javascript" src="/simpletip/sandbox/fringe/js/index.js"></script>
</body>
</html>
